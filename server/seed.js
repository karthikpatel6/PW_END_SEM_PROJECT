    ...
    const sampleOrders = await Order.create([
      {
        ...
        orderType: 'Dine-In',
        items: [
          { menuItem: menuItems[3]._id, name: 'Masala Dosa', price: 60, quantity: 2, station: 'Sauté' },
          { menuItem: menuItems[0]._id, name: 'Steamed Idli', price: 30, quantity: 1, station: 'Prep' },
          { menuItem: menuItems[14]._id, name: 'Filter Coffee', price: 20, quantity: 1, station: 'Cold' }
        ],
        status: 'placed',
        subtotal: 170,
        tax: 9,
      ...
      },
      {
        ...
        orderType: 'Dine-In',
        items: [
          { menuItem: menuItems[2]._id, name: 'Rava Idli', price: 35, quantity: 1, station: 'Prep' },
          { menuItem: menuItems[1]._id, name: 'Medhu Vada', price: 40, quantity: 2, station: 'Fryer' },
          { menuItem: menuItems[10]._id, name: 'Sambar Vada', price: 45, quantity: 1, station: 'Oven' }
        ],
        status: 'preparing',
        priority: 'priority',
        subtotal: 160,
        ...
        kitchenProgress: 45,
        kitchenNote: 'Preparing vada and idli'
      },
      {
        restaurant: restaurant._id,
        tokenNumber: '#T-103',
        ...
        orderType: 'Dine-In',
        items: [
          { menuItem: menuItems[11]._id, name: 'Ghee Podi Idli', price: 50, quantity: 4, station: 'Fryer' },
          { menuItem: menuItems[12]._id, name: 'Kesari Bath', price: 40, quantity: 2, station: 'Grill' },
          { menuItem: menuItems[13]._id, name: 'Pongal', price: 50, quantity: 1, station: 'Prep' }
        ],
        status: 'preparing',
        priority: 'rush',
        subtotal: 330,
        ...
        preparingAt: new Date(Date.now() - 18 * 60000),
        kitchenProgress: 65,
        kitchenNote: 'Garnishing idli podi'
      },
      {
        restaurant: restaurant._id,
        tokenNumber: '#T-104',
        ...
        orderType: 'Takeout',
        items: [
          { menuItem: menuItems[17]._id, name: 'Onion Uttapam', price: 55, quantity: 3, station: 'Prep' },
          { menuItem: menuItems[16]._id, name: 'Paper Roast', price: 70, quantity: 2, station: 'Bar' }
        ],
        status: 'preparing',
        subtotal: 305,
        tax: 15,
        ...
        kitchenProgress: 30,
        kitchenNote: 'Preparing uttapam batter'
      }
    ]);
